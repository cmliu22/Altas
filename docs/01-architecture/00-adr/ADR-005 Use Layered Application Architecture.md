...
- [[ADR-001-choose-python-as-primary-language]] - Records the decision to use Python as the primary language.
...
- [[ADR-004-use-src-based-package-layout]] - Records the decision to use a `src/`-based package layout.
