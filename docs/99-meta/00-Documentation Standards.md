...
Project Altas intentionally separates Obsidian-optimized internal documentation from GitHub-optimized public navigation. Inside `docs/`, Related Documents use Obsidian wiki links only. `README.md` and other GitHub-facing entry documents use standard Markdown links. Every document should be optimized for its primary environment.
